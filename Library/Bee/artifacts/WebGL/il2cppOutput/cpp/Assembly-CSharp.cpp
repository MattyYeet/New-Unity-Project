...
IL2CPP_EXTERN_C String_t* _stringLiteral2CCAD818751F0B6FFD44BC3CF8E97B4D7353E815;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PlayerController_OnTriggerEnter_mF2704872AEA62333341DCBEA2831320C385701D1 (PlayerController_t7E8D7042FA2D0DFEC54A1FCDF395161D88DAAE95* __this, Collider_t1CC3163924FCD6C4CC2E816373A929C1E3D55E76* ___other0, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		bool L_2;
		L_2 = GameObject_CompareTag_m6378BE50D009A93D46036F74CC3F7E2ECB0636E5(L_1, _stringLiteral4223EBA5706244B7BEF8F1BE58053D80CFDEF51E, NULL);
		if (!L_2)
		{
			goto IL_0032;
		}
	}
	{
		...
		// count = count + 1;
		int32_t L_5 = __this->___count_8;
		__this->___count_8 = ((int32_t)il2cpp_codegen_add(L_5, 1));
		// SetCountText ();
		PlayerController_SetCountText_m6A9F5CF284E511EBFE348D2500F866BAB8CE2C24(__this, NULL);
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PlayerController_SetCountText_m6A9F5CF284E511EBFE348D2500F866BAB8CE2C24 (PlayerController_t7E8D7042FA2D0DFEC54A1FCDF395161D88DAAE95* __this, const RuntimeMethod* method) 
{
	...
	if (!s_Il2CppMethodInitialized)
	{
		il2cpp_codegen_initialize_runtime_metadata((uintptr_t*)&_stringLiteral2CCAD818751F0B6FFD44BC3CF8E97B4D7353E815);
	...
	}
	{
		...
		VirtualActionInvoker1< String_t* >::Invoke(75 /* System.Void UnityEngine.UI.Text::set_text(System.String) */, L_5, _stringLiteral2CCAD818751F0B6FFD44BC3CF8E97B4D7353E815);
	}
